    ...
    if AI == True: 
        ...
        if user_id:
            try:
                ...
                footer_credit = "<b><a href='https://t.me/Chatkanhabot'>• 😠 REPORT ISSUE 😤 •</a>══<a href='https://t.me/Chatkanhabot'>• 😜 CONTACT YOUR boyfriend 😍 •</a></b>"
                ...
                print(error)
                await message.reply_text(f"**An error occurred:**\n\n**{error}**\n\n**Forward This Message To @Chatkanhabot**")
    else:
        return
